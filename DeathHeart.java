...
public class DeathHeart implements ImageFX {
	...
	public DeathHeart(GamePanel p, int xPos, int yPos) {
		panel = p;
		...
		spriteImage = ImageManager.loadBufferedImage("images/heart/death_heart.png");
