...
public class DraculaHeart implements ImageFX {
	...
	public DraculaHeart(GamePanel p, int xPos, int yPos) {
		panel = p;
		...
		spriteImage = ImageManager.loadBufferedImage("images/heart/dracula_transparent_heart.png");
