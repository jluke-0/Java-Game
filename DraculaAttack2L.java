...
public class DraculaAttack2L {
   ...
   public DraculaAttack2L(JPanel p, int xPos, int yPos, Player player) {
      panel = p;
      ...
      draculaAttackLeft = ImageManager.loadImage ("images/attacks/dracula2_attackL.png");
   ...
   if((y>=920 || x>=1819 || x<=0 ||collision) &&(x!=4500 && y!=4500)){
      if(collision){
