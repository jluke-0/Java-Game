...
public class AlucardHeart implements ImageFX {
	...
	public AlucardHeart(GamePanel p, int xPos, int yPos) {
		panel = p;
		...
		spriteImage = ImageManager.loadBufferedImage("images/heart/alucard_transparent_heart.png");
